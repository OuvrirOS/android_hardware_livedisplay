...
#define LOG_TAG "ouvrir.livedisplay@2.0-impl-sysfs"
#else
#define LOG_TAG "vendor.ouvrir.livedisplay@2.0-impl-sysfs"
#endif
...
// Methods from ::vendor::ouvrir::livedisplay::V2_0::IDisplayColorCalibration follow.
