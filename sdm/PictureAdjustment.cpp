...
#define LOG_TAG "ouvrir.livedisplay@2.0-impl-sdm"
#else
#define LOG_TAG "vendor.ouvrir.livedisplay@2.0-impl-sdm"
#endif
...
// Methods from ::vendor::ouvrir::livedisplay::V2_0::IPictureAdjustment follow.
...
Return<bool> PictureAdjustment::setPictureAdjustment(
        const ::vendor::ouvrir::livedisplay::V2_0::HSIC& hsic) {
    HsicConfig config = {0,
