...
#define LOG_TAG "vendor.ouvrir.livedisplay@2.0-service-legacymm"
...
using ::vendor::ouvrir::livedisplay::V2_0::IDisplayModes;
using ::vendor::ouvrir::livedisplay::V2_0::IPictureAdjustment;
using ::vendor::ouvrir::livedisplay::V2_0::legacymm::DisplayModes;
using ::vendor::ouvrir::livedisplay::V2_0::legacymm::PictureAdjustment;
