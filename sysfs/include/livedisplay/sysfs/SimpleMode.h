...
#include <vendor/ouvrir/livedisplay/2.0/IAutoContrast.h>
#include <vendor/ouvrir/livedisplay/2.0/IColorEnhancement.h>
#include <vendor/ouvrir/livedisplay/2.0/IReadingEnhancement.h>
...
class SimpleMode : public T {
  ...
  public:
    ...
    // Methods from ::vendor::ouvrir::livedisplay::V2_0::I* follow.
