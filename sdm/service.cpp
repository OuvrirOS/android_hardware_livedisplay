...
#define LOG_TAG "ouvrir.livedisplay@2.0-service-sdm"
#else
#define LOG_TAG "vendor.ouvrir.livedisplay@2.0-service-sdm"
#endif
...
using ::vendor::ouvrir::livedisplay::V2_0::sdm::DisplayModes;
using ::vendor::ouvrir::livedisplay::V2_0::sdm::PictureAdjustment;
using ::vendor::ouvrir::livedisplay::V2_0::sdm::SDMController;
