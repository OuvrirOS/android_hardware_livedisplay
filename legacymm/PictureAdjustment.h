...
#ifndef VENDOR_OUVRIR_LIVEDISPLAY_V2_0_PICTUREADJUSTMENT_H
#define VENDOR_OUVRIR_LIVEDISPLAY_V2_0_PICTUREADJUSTMENT_H

#include <vendor/ouvrir/livedisplay/2.0/IPictureAdjustment.h>
...
class PictureAdjustment : public IPictureAdjustment {
  public:
    ...
    // Methods from ::vendor::ouvrir::livedisplay::V2_0::IPictureAdjustment
    // follow.
    ...
    Return<bool> setPictureAdjustment(
            const ::vendor::ouvrir::livedisplay::V2_0::HSIC& hsic) override;
...
#endif  // VENDOR_OUVRIR_LIVEDISPLAY_V2_0_PICTUREADJUSTMENT_H
