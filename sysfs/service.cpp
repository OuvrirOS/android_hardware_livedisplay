...
#define LOG_TAG "ouvrir.livedisplay@2.0-service-sysfs"
#else
#define LOG_TAG "vendor.ouvrir.livedisplay@2.0-service-sysfs"
#endif
...
using ::vendor::ouvrir::livedisplay::V2_0::sysfs::AdaptiveBacklight;
using ::vendor::ouvrir::livedisplay::V2_0::sysfs::AutoContrast;
using ::vendor::ouvrir::livedisplay::V2_0::sysfs::ColorEnhancement;
using ::vendor::ouvrir::livedisplay::V2_0::sysfs::DisplayColorCalibration;
using ::vendor::ouvrir::livedisplay::V2_0::sysfs::ReadingEnhancement;
using ::vendor::ouvrir::livedisplay::V2_0::sysfs::SunlightEnhancement;
